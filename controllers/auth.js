...
exports.signin = (req,res) =>{
  ...
  exports.change_password = (req,res)=>{
    ...
    User.findOne({password_reset_token: password_reset_token, password_reset_time: { $gt: new Date(Date.now() - 60*60*60 * 1000) }}).then(function (user) {
     if (!user) {
  ...
  function forgetpassword_email(email,url) {
    ...
    *[x-apple-data-detectors],  /* iOS */
    ...
    <p>To set up a new password to your GreenLight account, click "Reset Your Password" below:</p>				           	
    ...
    <p>© Copyright GreenLight. All Rights Reserved. 2022</p>
              </td>
            </tr>
          </table>
